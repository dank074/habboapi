class UserService
{
    ...
    validate_username(user_name)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/validate_username', {user_name: user_name})
    ...
    validate_email(email_address)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/validate_email', {email_address: email_address})
    ...
    add_user(user_name, user_email, user_pass)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/add_user', {user_name: user_name, user_email: user_email, user_pass: user_pass})
    ...
    update_password(new_password, password)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/update_password', {new_password: new_password, password: password})
    ...
    update_email(new_email, password)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/update_email', {new_email: new_email, password: password})
    ...
    update_settings(data)
    {
        ...
        return this._$http.post(this._AppConstants.api + '/user/update_settings', {data: data})
