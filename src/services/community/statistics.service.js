class StatisticsService
{
	...
	statistics_info()
	{
		return this._$http.get(this._AppConstants.api + '/services/community/statistics/statistics_info')
	...
	users_online()
	{
		return this._$http.get(this._AppConstants.api + '/services/community/statistics/users_online')
