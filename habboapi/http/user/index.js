...
import HttpProfile from './profile.http';
import HttprCRON from './rcron.http';
...
class HttpUser
{
    constructor()
    {
        ...
        router.use('/profile', new HttpProfile);
        router.use('/rcron', HttpMiddleware.is_authenticated, new HttprCRON);
    ...
    validate_username(req, res, next)
    {
        ...
        return HotelUser.validate_username(req.body.user_name)
    ...
    validate_email(req, res, next)
    {
        ...
        return HotelUser.validate_email(req.body.email_address)
    ...
    add_user(req, res, next)
    {
        ...
        return HotelUser.add_user(req.body.user_name, req.body.user_email, req.body.user_pass, req.ip)
    ...
    update_password(req, res, next)
    {
        ...
        return HotelUser.update_password(req.user.user_id, req.body.new_password, req.body.password)
    ...
    update_email(req, res, next)
    {
        ...
        return HotelUser.update_email(req.user.user_id, req.body.new_email, req.body.password)
    ...
    update_settings(req, res, next)
    {
        ...
        return HotelUser.update_settings(req.user.user_id, req.body.data)
