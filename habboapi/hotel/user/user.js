...
class User
{
    ...
    static validate_email(email_address)
    {
        return new Promise((resolve, reject) =>
        {
            ...
            return new HotelUserDB({mail: email_address}).fetch()
    ...
    static user_info(user_id)
    {
        return new Promise((resolve, reject) =>
        {
            ...
            return new HotelUserDB({id: user_id}).fetch({
                withRelated: [
                    'last_login',
                    'currency',
                    'friends',
    ...
    static add_user(user_name, user_email, user_pass, user_ip)
    {
        return new Promise((resolve, reject) =>
        {
            ...
            .then(() =>
            {
                return new HotelUserDB().where('ip_register', user_ip).count();
            })

            .then((count) =>
            {
                if(count >= __config.hotel.new_user.max_accounts) return reject(new Error('max_accounts'));
    ...
    static update_settings(user_id, data)
    {
        return new Promise((resolve, reject) =>
        {
            ...
            return new HotelUserSettingsDB({user_id: user_id}).fetch({
